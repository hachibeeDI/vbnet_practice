...
#Region "Schedulerのイベント"
        ...
        ''' <remarks> パフォーマンスが問題になる場合、DBアクセスの部分を非同期化する？ </remarks>
        Private Sub _
...
#Region "SchedulerStorageのイベント"
        ...
        Handles _scheduler_storage.AppointmentsInserted
            ...
            Dim apoint = DirectCast(e.Objects, DevExpress.XtraScheduler.Appointment)
            ...
            'もっと時間かけてハックすればスマートな解決策はありそう
            Dim num_seats = apoint.StatusId
